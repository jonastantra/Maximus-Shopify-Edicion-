...
var hsObserver=new MutationObserver(function(mutations){for(var idx=0;idx<mutations.length;idx++){var mutation=mutations[idx];if(mutation.attributeName=="src"){var img=mutation.target;img.removeAttribute("srcset");img.removeAttribute("data-srcset");img.removeAttribute("data-src")}}});var config={attributes:!0};var targets=document.getElementsByClassName("hs-lazyload");for(var i=0;i<targets.length;i++)hsObserver.observe(targets[i],config);document.addEventListener("lazybeforeunveil",function(e){setTimeout(function(){e.target.style.minWidth=null},500)},{once:!0})